...
export default function Footer() {
  ...
  <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
    <div className="grid md:grid-cols-4 gap-8 md:gap-12 lg:gap-16">
      {/* Company Section */}
      <div>
        <h3 className="text-white text-lg font-semibold mb-6">Creative Business</h3>
        <p className="text-gray-400 text-sm leading-relaxed mb-6">
          Transforming ideas into impact through innovative design and strategic thinking.
        </p>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li>
            <a href="#strategy" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">
              Strategy & Consulting
            </a>
          </li>
          <li>
            <a href="#design" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">
              Design & Branding
            </a>
          </li>
          <li>
            <a href="#development" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">
              Development
            </a>
          </li>
          <li>
            <a href="#marketing" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm">
              Marketing & Growth
            </a>
          </li>
          <li>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <a href="mailto:hello@creativebusiness.com" className="text-white hover:text-blue-400 transition-colors duration-300 text-sm">
              hello@creativebusiness.com
            </a>
          </div>
          <div>
            <p className="text-gray-400 text-sm mb-1">Phone</p>
            <a href="tel:+1234567890" className="text-white hover:text-blue-400 transition-colors duration-300 text-sm">
              +1 (234) 567-890
            </a>
          </div>
          <div>
